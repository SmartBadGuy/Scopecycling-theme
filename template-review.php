...
<div class="centerwrapper">
    ...
    <?php if (have_posts()): while (have_posts()) : the_post(); ?>
        ...
        <div class="centerwrapper">
            ...
            <?php
                global $wpdb;
                $oems = $wpdb->get_results("select * from ".$wpdb->prefix."review_slider".$query_add." order by `title`");
    
                foreach($oems as $oem) {
                    echo '<div class="multipart-slide column">';
                    echo '  <a target="_blank" href="'.get_template_directory_uri().'/img/review/'.$oem->logo.'"><img style="" src="'.get_template_directory_uri().'/img/review/'.$oem->bike.'" alt="'.$oem->title.'">';
